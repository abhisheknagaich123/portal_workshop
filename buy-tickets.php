  ...
  <div class="site-wrap">
    ...
    <div class="site-section site-hero inner">
      <div class="container">
        <div class="row align-items-center">
          <div class="col-md-10">
            <span class="d-block mb-3 caption"><?php echo $get_product['0']['user_name']?></span>
            <h1 class="d-block mb-4">buy tich</h1>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="site-section">
      <div class="container">
          ...
          <div class="col-md-10 col-lg-15 mb-5 mb-lg-0" data-aos="fade-up" data-aos-delay="400">
        ...
        <div class="slide-one-item home-slider owl-carousel">
          ...
          <div class="row justify-content-center">
           <div class="testimony text-center col-md-5">
              ...
              <blockquote>
                ...
                <p class="author">&mdash; mr Aditya gautam</p>
              </blockquote>
            </div>
          </div>
          ...
          <div class="row justify-content-center">
            <div class="testimony text-center col-md-5">
              ...
              <blockquote>
                <p>&ldquo;Lorem ipsum dolor sit amet, consectetur adipisicing elit. Maxime exercitationem alias reprehenderit error quidem aliquam ad minus, veritatis modi.&rdquo;</p>
                <p class="author">&mdash; Lalit kumar</p>
              </blockquote>
            </div>
          </div>
          ...
          <div class="row justify-content-center">
            <div class="testimony text-center col-md-5">
              ...
              <blockquote>
                <p>&ldquo;Lorem ipsum dolor sit amet, consectetur adipisicing elit. Maxime exercitationem alias reprehenderit error quidem aliquam ad minus, veritatis modi.&rdquo;</p>
                <p class="author">&mdash; mr Abhinav khatri </p>
              </blockquote>
            </div>
          ...
          <div class="row justify-content-center">
            <div class="testimony text-center col-md-5">
              ...
              <blockquote>
                <p>&ldquo;Lorem ipsum dolor sit amet, consectetur adipisicing elit. Maxime exercitationem alias reprehenderit error quidem aliquam ad minus, veritatis modi.&rdquo;</p>
                <p class="author">&mdash; Mr  Diwakar Srivastava </p>
              </blockquote>
            </div>
          </div>
